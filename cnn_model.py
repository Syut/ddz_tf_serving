...
def conv_net(x, weights, biases, dropout, is_training=True):
    ...
    conv4 = conv2d(conv3, weights['wc4'], biases['bc4'], is_training=is_training)
    conv5 = conv2d(conv4, weights['wc5'], biases['bc5'], is_training=is_training)
    conv6 = conv2d(conv5, weights['wc6'], biases['bc6'], s2=2, is_training=is_training)
    conv7 = conv2d(conv6, weights['wc7'], biases['bc7'], s2=2, is_training=is_training)
    conv8 = conv2d(conv7, weights['wc8'], biases['bc8'], s2=2, is_training=is_training)
...
def conv_net_k(x, weights, biases, dropout, is_training=True):
    x_input = tf.transpose(x, perm=[0, 2, 3, 1])
